...
template<typename T>
inline T cStoN(const std::string & str, std::ios_base& (*format)(std::ios_base&) = std::dec)
{
	T num;
...
template<typename TVec>
sf::Vector2<TVec> cStoV(const std::string & str, std::ios_base& (*format)(std::ios_base&) = std::dec)
{
	TVec num1, num2;
...
inline sf::Uint8 cStoUB(const std::string & str, std::ios_base& (*format)(std::ios_base&) = std::dec)
{
	sf::Uint16 num;
	if (str2Num(num, str, format))
		return num;
...
inline sf::Uint16 cStoUS(const std::string & str, std::ios_base& (*format)(std::ios_base&) = std::dec)
{
	sf::Uint16 num;
	if (str2Num(num, str, format))
		return num;
...
inline sf::Uint32 cStoUI(const std::string & str, std::ios_base& (*format)(std::ios_base&) = std::dec)
{
	sf::Uint32 num;
	if (str2Num(num, str, format))
		return num;
...
inline sf::Uint64 cStoUL(const std::string & str, std::ios_base& (*format)(std::ios_base&) = std::dec)
{
	sf::Uint64 num;
	if (str2Num(num, str, format))
		return num;
...
inline sf::Int8 cStoB(const std::string & str, std::ios_base& (*format)(std::ios_base&) = std::dec)
{
	sf::Int16 num;
	if (str2Num(num, str, format))
		return num;
...
inline sf::Int16 cStoS(const std::string & str, std::ios_base& (*format)(std::ios_base&) = std::dec)
{
	sf::Int16 num;
	if (str2Num(num, str, format))
		return num;
...
inline sf::Int32 cStoI(const std::string & str, std::ios_base& (*format)(std::ios_base&) = std::dec)
{
	sf::Int32 num;
	if (str2Num(num, str, format))
		return num;
...
inline sf::Int64 cStoL(const std::string & str, std::ios_base& (*format)(std::ios_base&) = std::dec)
{
	sf::Int64 num;
	if (str2Num(num, str, format))
		return num;
